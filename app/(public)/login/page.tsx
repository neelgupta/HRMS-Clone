  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#f8fbff_0%,#eef4ff_45%,#ffffff_100%)] dark:bg-[linear-gradient(180deg,#0f172a_0%,#1e293b_50%,#0f172a_100%)] px-6 py-10 text-slate-900 dark:text-slate-100">
      ...
      <div className="mx-auto grid min-h-[calc(100vh-8rem)] max-w-6xl items-center gap-8 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <section className="w-full rounded-[2rem] border border-white/70 bg-white/90 p-8 shadow-xl shadow-slate-200 backdrop-blur dark:border-slate-700/50 dark:bg-slate-800/90 dark:shadow-indigo-900/20 md:p-10">
          <div className="mx-auto max-w-md">
            <p className="text-sm font-semibold uppercase tracking-[0.24em] text-indigo-600 dark:text-indigo-400">Sign In</p>
            <h1 className="mt-4 text-3xl font-semibold tracking-tight text-slate-950 dark:text-white">Sign in to WorkNest</h1>
            <p className="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-400">Manage your HR operations from a clean dashboard built for day-to-day execution.</p>
            ...
            <form onSubmit={onSubmit} className="mt-8 space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-500 dark:text-slate-400">Secure access for your HR admin workspace</span>
