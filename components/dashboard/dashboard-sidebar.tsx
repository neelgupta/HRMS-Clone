...
const hrNavItems: NavItem[] = [
  { label: "Dashboard", href: ROUTES.HR.DASHBOARD, icon: MdDashboard, available: true },
  { label: "Company Setup", href: ROUTES.HR.COMPANY_SETUP, icon: MdBusiness, available: true },
  { label: "Employees", href: ROUTES.HR.EMPLOYEES.LIST, icon: MdPeople, available: true },
  { label: "Attendance", href: ROUTES.HR.ATTENDANCE.LIST, icon: MdAccessTime, available: true },
  { label: "Attendance Reports", href: ROUTES.HR.ATTENDANCE.REPORTS, icon: MdAssessment, available: true },
  { label: "Shifts", href: ROUTES.HR.SHIFTS, icon: MdSchedule, available: true },
  { label: "Leave Management", href: ROUTES.HR.LEAVE.LIST, icon: MdEventNote, available: true },
  { label: "Leave Types", href: ROUTES.HR.LEAVE.TYPES, icon: MdPolicy, available: true },
  { label: "Leave Policy", href: ROUTES.HR.LEAVE.POLICY, icon: MdPolicy, available: true },
...
const employeeNavItems: NavItem[] = [
  { label: "My Dashboard", href: ROUTES.EMPLOYEE.DASHBOARD, icon: MdDashboard, available: true },
  { label: "My Attendance", href: ROUTES.EMPLOYEE.DASHBOARD, icon: MdAccessTime, available: true },
  { label: "My Profile", href: ROUTES.EMPLOYEE.DASHBOARD, icon: MdPerson, available: true },
];
